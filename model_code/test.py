...
from model import RumorClassifier, BertweetClassifier, BertweetTextClassifier
import argparse
...
MODEL_DICT = {'bert': RumorClassifier, 'bertweet': BertweetClassifier, 'bertweet_text': BertweetTextClassifier}
